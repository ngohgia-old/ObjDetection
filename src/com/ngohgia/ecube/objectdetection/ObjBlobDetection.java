...
public class ObjBlobDetection {
    ...
    public ObjBlobDetection(Mat rgbaImage, int pyrDownCount) {
        ...
        // Convert the pyrDown image to HSV color space
        Imgproc.cvtColor(mPyrDownMat, mHsvMat, Imgproc.COLOR_RGB2HSV_FULL);
    }
    
    public void updateMask(){
    	// Create Mask mat by returning only colors in range defined by mLowerBound and mUpperBound
